...
public class GUIScript : MonoBehaviour {
    ...
    void OnGUI() {
 		...
 		scrollPos2 = GUI.BeginScrollView(new Rect(10, 10, 120, 285), scrollPos2, new Rect(0, 0, 100, 500));
		...
		if(GUI.Button(new Rect(0, 475, 100, 20), "Zombie"))
 		...
 		if(idleStandbool){
    		scrollPosition = GUI.BeginScrollView(new Rect(150, 10, 150, 285), scrollPosition, new Rect(0, 0, 120, 2550));
        	...
        	scrollPosition = GUI.BeginScrollView(new Rect(150, 10, 220, 285), scrollPosition, new Rect(0, 0, 200, 475));
